  ...
  return (
    <div className="min-h-screen bg-background flex flex-col items-center justify-center p-4">
      ...
      <div className="bg-white rounded-md border border-border shadow-xl w-full max-w-md p-8">
        ...
        {/* Demo instructions */}
        <div className="mt-8 border-t border-border pt-4 text-xs text-text-secondary flex flex-col gap-1.5">
          <p className="font-bold">Demo Login Accounts:</p>
          <div className="flex justify-between border-b border-border py-1">
            <span>Admin ID: <b>admin@dayflow.com</b></span>
            <span>Password: <b>AdminPassword1!</b></span>
          </div>
          <div className="flex justify-between py-1">
            <span>Employee ID: <b>john.doe@dayflow.com</b></span>
            <span>Password: <b>Password1!</b></span>
          </div>
        </div>
