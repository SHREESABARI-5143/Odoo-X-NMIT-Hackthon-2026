...
async function main() {
    ...
    const defaultPasswordHash = await bcryptjs_1.default.hash('Password@123', 10);
    // 2. Admin User
    const admin = await prisma.user.create({
        data: {
            ...
            bankAccount: (0, crypto_1.encrypt)('987654321098'),
            bankName: 'Silicon Valley Bank',
            ifsc: (0, crypto_1.encrypt)('SVBK0001234'),
            pan: (0, crypto_1.encrypt)('ADMIN1234P'),
            uan: (0, crypto_1.encrypt)('100000000001'),
    ...
    const john = await prisma.user.create({
        data: {
            ...
            bankName: 'Chase Bank',
            ifsc: (0, crypto_1.encrypt)('CHAS0009876'),
            pan: (0, crypto_1.encrypt)('ABCDE1234F'),
            uan: (0, crypto_1.encrypt)('100900800701'),
            dob: '1992-06-15',
            address: (0, crypto_1.encrypt)('742 Evergreen Terrace, San Francisco, CA'),
            nationality: 'American',
            personalEmail: (0, crypto_1.encrypt)('john.doe.personal@gmail.com'),
            gender: 'Male',
    ...
    const jane = await prisma.user.create({
        data: {
            ...
            bankAccount: (0, crypto_1.encrypt)('234567890123'),
            bankName: 'Bank of America',
            ifsc: (0, crypto_1.encrypt)('BOFA0004321'),
            pan: (0, crypto_1.encrypt)('XYZPS5678G'),
            uan: (0, crypto_1.encrypt)('100900800702'),
            dob: '1995-11-20',
            address: (0, crypto_1.encrypt)('100 Broadway Ave, New York, NY'),
            nationality: 'American',
            personalEmail: (0, crypto_1.encrypt)('jane.smith.design@gmail.com'),
            gender: 'Female',
    ...
    const alex = await prisma.user.create({
        data: {
            ...
            bankAccount: (0, crypto_1.encrypt)('345678901234'),
            bankName: 'Wells Fargo',
            ifsc: (0, crypto_1.encrypt)('WFGO0007788'),
            pan: (0, crypto_1.encrypt)('ALEXW9876K'),
            uan: (0, crypto_1.encrypt)('100900800703'),
            dob: '1993-04-10',
            address: (0, crypto_1.encrypt)('500 Market St, San Francisco, CA'),
            nationality: 'American',
            personalEmail: (0, crypto_1.encrypt)('alex.wong.qa@gmail.com'),
            gender: 'Male',
            maritalStatus: 'Single',
